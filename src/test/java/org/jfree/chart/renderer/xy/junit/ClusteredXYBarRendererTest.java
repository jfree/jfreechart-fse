 ...
 */
public class ClusteredXYBarRendererTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(ClusteredXYBarRendererTest.class);
    }
     ...
     */
    public ClusteredXYBarRendererTest(String name) {
        super(name);
    }
