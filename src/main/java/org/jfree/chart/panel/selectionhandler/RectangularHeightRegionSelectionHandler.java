...
public class RectangularHeightRegionSelectionHandler extends RegionSelectionHandler {
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        selectionRect = getRect(startPoint, pt2, panel.getScreenDataArea());
    ...
    /**
     * finishes the selection and calls the {@link org.jfree.chart.panel.selectionhandler.SelectionManager} of
     ...
     * @param plotarea the data area of the chart panel
     * @return a new rectangle that has both points in opposite corners
     */
    private Rectangle getRect(Point2D p1, Point2D p2, Rectangle2D plotarea ) {
        int minX, minY;
        int w, h;
        ...
        // process y and h
        minY = (int) plotarea.getMinY();
        h = (int) plotarea.getHeight();
