 ...
 */
public class GenericObjectList<Value>
        implements Cloneable, Serializable, Iterable<Value> {
     ...
     */
    public GenericObjectList(final int initialCapacity) {
     ...
     */
    protected GenericObjectList(final int initialCapacity,
                                final int increment) {
    ...
    public Value get(final int index) {
        ...
        // Always safe since the set method only allows Value
        return (Value) result;
    }
     ...
     */
    public void set(final int index, final Value object) {
        if (index < 0) {
     ...
     */
    public int indexOf(final Value object) {
    ...
    public boolean equals(final Object obj) {
        ...
        final GenericObjectList other = (GenericObjectList) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        @SuppressWarnings("unchecked")
        final GenericObjectList<Value> clone
                = (GenericObjectList<Value>) super.clone();
    ...
    private void readObject(final ObjectInputStream stream)
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (index != -1) {
                set(index, (Value) stream.readObject());
            }
        }
    ...
    public Iterator<Value> iterator() {
        return (Iterator<Value>) Arrays.asList(objects).iterator();
    }
}
